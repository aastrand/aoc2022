...
def scenic_score(x, y, rows, cols):
    ...
    return (
        num_visible(val, left)
        * num_visible(val, right)
        * num_visible(val, top)
        * num_visible(val, bottom)
    )
...
def main():
    ...
    assert is_visible(1, 1, rows, cols) is True
    assert is_visible(2, 1, rows, cols) is True
    assert is_visible(3, 1, rows, cols) is False
    assert is_visible(1, 2, rows, cols) is True
    assert is_visible(2, 2, rows, cols) is False
    assert is_visible(3, 2, rows, cols) is True

    assert is_visible(1, 3, rows, cols) is False
    assert is_visible(2, 3, rows, cols) is True
